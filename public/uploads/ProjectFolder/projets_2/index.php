...
<body data-spy="scroll" data-target=".navbar" data-offset="60">
	...
	<section id="about" class="container-fluid">
		<div class="col-xs-8 col-md-4 profile-picture">
			<img src="images/me.jpg" alt="John" class="img-circle">
		</div>
		<div class="heading">
	...
	<section id="skills">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="progress">
						<div class="progress-bar" role="progressbar" aria-valuenow="85" aria-vluemin="0" aria-valuemax="100" style="width: 85%;">
							HTML 85%
						</div>
					</div>
					<div class="progress">
					...
					<div class="progress">
						<div class="progress-bar" role="progressbar" aria-valuenow="90" aria-vluemin="0" aria-valuemax="100" style="width: 90%;">
							JAVASCRIPT 90%
						</div>
					</div>
				...
				<div class="col-md-6">
					...
					<div class="progress">
						<div class="progress-bar" role="progressbar" aria-valuenow="80" aria-vluemin="0" aria-valuemax="100" style="width: 80%;">
							BOOTSTRAP 80%
						</div>
					</div>
					<div class="progress">
						<div class="progress-bar" role="progressbar" aria-valuenow="75" aria-vluemin="0" aria-valuemax="100" style="width: 75%;">
							ANGULAR 75%
						</div>
					</div>
				</div>
